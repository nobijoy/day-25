        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 mx-auto">
                    <div class="card">
                        <div class="card-header bg-dark text-white">Edit Blog</div>
                        <div class="card-body">
                            ...
                            <form action="{{route('update-blog', ['id' => $blog->id])}}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" value="{{$blog->title}}" class="form-control" name="name"/>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-md-3">Author Name</label>
                                    <div class="col-md-9">
                                        <input type="email" value="{{$blog->author}}" class="form-control" name="email"/>
                                    </div>
                                </div>
                                <div class="form-group row">
